...
export function AdminInvoicesTable({ client }: AdminInvoicesTableProps) {
  ...
  const _updateInvoice = useUpdateInvoice();
  ...
  const clientInvoices =
    invoices?.filter((inv) => inv.client.toString() === client.id.toString()) ||
    [];
            ...
            <DialogContent className="bg-neutral-900 border-neutral-800 text-white">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="invoiceNo" className="text-white">
                    Invoice Number
                  </Label>
                  <Input
                    id="invoiceNo"
                ...
                clientInvoices.map((invoice) => (
                  ...
                  >
                    ...
                    <TableCell className="text-white/70">
                      {new Date(
                        Number(invoice.dueDate) / 1_000_000,
                      ).toLocaleDateString()}
                    </TableCell>
